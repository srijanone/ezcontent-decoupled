...
var paths = {
	...
	sassDest: 'src/static/css',
	jsSrc: ['./src/static/js/source/*.js', './src/static/js/component/*.js'],
	jsDest: './src/static/js/build',
	imgSrc: './src/static/images/source/**/*.{png,jpg,gif}',
	imgDest: './src/static/images/optimized',
	svgSrc: './src/static/images/source/**/*.svg',
	svgDest: './src/static/images/optimized'
}
